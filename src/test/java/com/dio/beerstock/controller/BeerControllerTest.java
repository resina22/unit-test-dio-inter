...
import com.dio.beerstock.beerstock.controller.BeerController;
...
public class BeerControllerTest {
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        ...
        //then
        mockMvc.perform(
            get(BEER_API_URL_PATH).contentType(MediaType.APPLICATION_JSON)
        )
            .andExpect(status().isOk())
    ...
    @Test
    void whenGETListWithoutIsCalledThenOkStatusIsReturned() throws Exception {
        //give
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    void whenDELETEIsCalledWithValidIdThenNoContentStatusIsReturned() throws Exception {
        ...
        //when
        doNothing().when(beerService).deletedById(beerDTO.getId());
    ...
    void whenDELETEIsCalledWithValidIdThenNotFoundStatusIsReturned() throws Exception {
        //give
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        beerDTO.setId(INVALID_BEER_ID);

        //when
        doThrow(BeerNotFoundException.class).when(beerService).deletedById(beerDTO.getId());
    ...
    void whenPATCHIsCalledToIncrementDiscountThenOkStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(
            patch(
    BEER_API_URL_PATH + "/" + VALID_BEER_ID + BEER_API_SUBPATH_INCREMENT_URL
            )
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void whenPATCHIsCalledToIncrementDiscountThenBadRequestStatusIsReturned() throws Exception {
        //give
    ...
    void whenPATCHIsCalledToDecrementDiscountThenOkStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(
            patch(
    BEER_API_URL_PATH + "/" + VALID_BEER_ID + BEER_API_SUBPATH_DECREMENT_URL
            )
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(quantityDTO))
        )
    ...
    @Test
    void whenPATCHIsCalledToDecrementDiscountThenBadRequestStatusIsReturned() throws Exception {
        //give
        QuantityDTO quantityDTO = QuantityDTO.builder().quantity(30).build();
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity()))
            .thenThrow(EmptyOrNegativeBeerStockException.class);
